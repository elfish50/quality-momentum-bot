...
async def cmd_strategy(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "BB 3rd Touch Breakout + Quality Screen\n"
        "==============================\n\n"
        ...
        "  RSI turning up from oversold (< 45)\n"
        "  Volume 15%+ above average (real buying)\n\n"
        "STEP 3 — TARGETS\n"
        "  TP1 = Middle Band  (~5-8% gain)\n"
        "  TP2 = Upper Band   (~10-15% gain)\n\n"
        "STEP 4 — RISK\n"
        "  Stop = Below lowest of 3 touches\n"
        "  Risk = 1% of account per trade\n"
        "  Hold = Bot decides (1-8 weeks)\n\n"
        "WHY 3RD TOUCH WORKS:\n"
        "  1st touch = possible support\n"
        "  2nd touch = support confirmed\n"
        "  3rd touch + breakout = sellers exhausted,\n"
        "  buyers taking control = high probability move\n"
    )
